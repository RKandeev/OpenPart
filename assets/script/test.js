...
let questions = [
    ...
    },
    {
        question: "У Вас есть 1 млн. руб. и Вам нужно решать «жилищный вопрос». Вы можете выбрать один из двух вариантов:<br> <br>" +
            "&emsp;1) внести его как первоначальный взнос, купить квартиру за 6 млн. руб. в ипотеку на 20 лет со ставкой 10% и страховкой кредита 1% в год<br>" +
            "&emsp;2) арендовать эту квартиру за 20 тыс. руб. в месяц, а имеющийся 1 млн. руб. вложить под 10% годовых<br> <br>" +
...
getNewQuestion = () => {
    ...
    inputs.forEach((e) => {
        ...
        if (currentQuestion.view){
            e.type = "radio"
            numberOfAnswers.innerText = "* - можно выбрать один вариант"
        } else {
            e.type = "checkbox"
